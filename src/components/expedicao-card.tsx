    ...
    >
      <div className="relative aspect-[4/5] overflow-hidden">
        ...
        <div className="absolute inset-x-0 bottom-0 p-6 text-areia md:p-7">
          <div className="flex items-center gap-3 text-[0.65rem] uppercase tracking-[0.22em] text-areia/80">
            <span>{expedicao.duracao}</span>
            <span className="h-1 w-1 rounded-full bg-cobre" />
            <span>{expedicao.nivel}</span>
          </div>
          <h3 className="mt-3 font-display text-2xl md:text-3xl text-balance">
            {expedicao.nome}
          </h3>
          <p className="mt-2 text-sm text-areia/75 line-clamp-2 text-pretty">
            {expedicao.descricao_curta}
          </p>

          <div className="mt-5 flex items-end justify-between">
            <div>
              <div className="text-[0.65rem] uppercase tracking-[0.22em] text-areia/60">A partir de</div>
              <div className="font-display text-xl text-cobre-soft">{formatPrice(expedicao.preco)}</div>
            </div>
            <span className="inline-flex h-11 w-11 items-center justify-center rounded-full border border-areia/30 text-areia transition-all group-hover:bg-cobre group-hover:border-cobre">
