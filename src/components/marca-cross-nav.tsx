...
const MARCAS = {
  ...
  "canastra-a-cavalo": { logo: logoCanastra, nome: "Canastra a Cavalo", tagline: "Explore a Serra da Canastra a cavalo por rotas cuidadosamente selecionadas.", to: "/marcas/canastra-a-cavalo" as const },
};
