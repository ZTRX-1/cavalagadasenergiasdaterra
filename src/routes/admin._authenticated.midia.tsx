...
function MidiaPage() {
  ...
  return (
    <div>
      ...
      <AdminPageIntro>
        <strong className="text-[color:var(--admin-cinza-1)]">Galeria de cada expedição.</strong> As fotos enviadas aqui aparecem direto no carrossel da página pública. A foto marcada como <strong className="text-[color:var(--admin-dourado)]">CAPA</strong> vira o hero (imagem grande no topo) e também a capa do card na listagem. Recomendado: 8 fotos por expedição, todas com legenda curta.
      </AdminPageIntro>
