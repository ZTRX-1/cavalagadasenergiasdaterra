    ...
    <div>
      ...
      <div className="space-y-4">
        <div className="admin-card">
          <h3 className="font-display text-[16px] text-[color:var(--admin-cinza-1)] mb-3">Novo documento</h3>
          <div className="grid gap-3 md:grid-cols-2">
            ...
            <div className="md:col-span-2">
              <label className="text-[11px] uppercase tracking-[0.18em] text-[color:var(--admin-cinza-3)]">Participante (opcional)</label>
          ...
          <div className="mt-4">
            <AdminUploader
              ...
              hint="Apenas PDF. Documentos de participantes ficam isolados (não aparecem para outros)."
            />
          </div>
        </div>
                  ...
                  return (
                    <tr key={d.id} className="border-t border-[color:var(--admin-borda)] hover:bg-[color:var(--admin-petroleo)]/20">
                      ...
                      <td className="px-3 py-4 text-[11px] text-[color:var(--admin-cinza-3)] space-y-0.5">
                        ...
                        {!d.expedicao_id && !d.reserva_id && !d.participante_id && <div>Geral</div>}
                      </td>
