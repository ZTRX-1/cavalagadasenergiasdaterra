-- Fase 2: quando reserva for paga integralmente, marcar todos os participantes como 'confirmado'
...
BEGIN
  ...
  -- Fase 2: se virou pago integralmente agora, confirma participantes
...
-- Recria o trigger pra garantir que está ativo
